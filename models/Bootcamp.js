...
//Deletar cursos quando um bootcamp for deletado em formato de cascade
BootcampSchema.pre("remove", async function(next) {
  console.log(`Cursos sendo removido do bootcamp ${this._id} - ${this.name}`);
  await this.model("Course").deleteMany({ bootcamp: this._id });
  next();
});

//Criar populate reverso com virtuals de courses em bootcamp
